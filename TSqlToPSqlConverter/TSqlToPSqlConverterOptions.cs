...
{
    public class TSqlToPsqlConverterOptions
    {
        public TSqlToPsqlConverterOptions()
        {
            IndentString = "\t";
            SpacesPerTab = 4;
            MaxLineWidth = 999;
        ...
        private static readonly TSqlToPsqlConverterOptions _defaultOptions = new TSqlToPsqlConverterOptions();

        public TSqlToPsqlConverterOptions(string serializedString) : this() {
